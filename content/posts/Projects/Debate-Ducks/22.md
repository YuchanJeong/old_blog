...
- 이름 유효성 검사(회원가입에서도 필요), createObjectURL 에러 해결 _\*[참조](https://github.com/SuSang-YuHee/Debate-Ducks-Client/issues/107)_, 페이지 접근 권한 설정, 프로필 변경 취소 버튼 제작
- 이름 변경 시 사진 밀리는 거 해결, 인풋에 기존 이름 유지 및 placeholder 색 구분
