...
아직 개선 사항들은 남았지만 v2.1.0을 마지막으로 주 일과로 debate-ducks 프로젝트를 개발하는 일은 마무리하고자 한다. (다만 에러를 개선하는 작업은 꾸준히 진행 할 예정) 지금부터는 취업을 위한 이론 공부와 영어 공부 그리고 이전부터 사용해 보고 싶었던 React-Native를 공부하며 조그마한 앱을 만들어볼 것이다.
